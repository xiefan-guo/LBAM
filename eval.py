...
parser.add_argument('--pre_trained', type=str, default='F:\pycharm_python\LBAM\snapshots\default\ckpt\model_10.pth', help='pre-trained models for fine-tuning')
...
parser.add_argument('--image_root', type=str, default='F:\pycharm_python\Paper-PyTorch\data\place2')
parser.add_argument('--mask_root', type=str, default='F:\pycharm_python\Paper-PyTorch\data\mask')
